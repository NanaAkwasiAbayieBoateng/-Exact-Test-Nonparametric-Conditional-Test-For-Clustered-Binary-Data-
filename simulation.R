...
apply(c,3,fisher.test(c,B=2000,workspace=2e+10))
 ...
 b=matrix(c(1,2,3,4),2,2)
  ...
  library(CorrBin)
  library(lattice)
  ss <- expand.grid(Trt=0:2, ClusterSize=1:10, Freq=5)
 ...
 rm(list=ls())
 genfunc=function(p,q,meanlambda,N){
 ...
 genfunc(p=0.1,q=0.2,meanlambda=5,N=30)
 
 obs1=cbind(genfunc(p=0.1,q=0.2,meanlambda=5,N=30),Trt=rep(1,N=30))
 obs2=cbind(genfunc(p=0.1,q=0.2,meanlambda=5,N=30),Trt=rep(2,N=30))
 ...
 for (i in 1:1000){
   ...
   obs1=cbind(genfunc(p=0.1,q=0.9,meanlambda=10,N=50),Trt=rep(1,N=50))
   obs2=cbind(genfunc(p=0.9,q=0.9,meanlambda=10,N=50),Trt=rep(2,N=50))
